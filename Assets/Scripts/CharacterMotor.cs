...
public class CharacterMotor : MonoBehaviour
{
	...
	private void UpdateFunction()
	{
		...
		transform.Translate(Vector3.right*inputDevice.LeftStickX *0.1f);
		transform.Translate(Vector3.forward*inputDevice.LeftStickY*0.1f );

		transform.Rotate(Vector3.up*inputDevice.RightStickX*10f);
		//transform.Rotate(Vector3.left*inputDevice.RightStickY*10f);
